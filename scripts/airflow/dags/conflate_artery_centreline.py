...
D1_ARTERIES_CENTRELINE = create_bash_task_nested(DAG, 'D1_arteries_centreline')
...
B3_ARTERIES_INTERSECTION >> D1_ARTERIES_CENTRELINE
C4_ARTERIES_MIDBLOCK >> D1_ARTERIES_CENTRELINE
